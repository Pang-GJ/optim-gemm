...
void AddDot4x4(int k, float* a, int lda, float* b, int ldb, float* c, int ldc) {
  ...
  c_00_reg = c_01_reg = c_02_reg = c_03_reg = 0.0;
  c_10_reg = c_11_reg = c_12_reg = c_13_reg = 0.0;
  c_20_reg = c_21_reg = c_22_reg = c_23_reg = 0.0;
  c_30_reg = c_31_reg = c_32_reg = c_33_reg = 0.0;
